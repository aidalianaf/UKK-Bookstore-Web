...
if(isset($_POST['submit']))
{
  ...
  {  
        ...
        if(mysqli_num_rows($result) > 0)
        {
             ...
             print'
                <script type="text/javascript">alert("Berhasil Login!!!");</script>
                  ';
        }
        else
        {    print'
              <script type="text/javascript">alert("Masukkan Username dan Password dengan benar!!");</script>
                  ';
        }
  }
  else if($_POST['submit']=="register")
  {
        ...
        {   
               print'
               <script type="text/javascript">alert("Akun telah terdaftar");</script>
                    ';
...
<head>
    ...
    <style>
      .modal-header {background:#712ac1;color:#fff;font-weight:800;}
      .modal-body{font-weight:800;}
      .modal-body ul{list-style:none;}
      .modal .btn {background:#712ac1;color:#fff;}
      .modal a{color:#712ac1;}
  ...
  <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
         ...
         <!-- FORM LOGIN/ SIGN IN DAN REGISTRASI, PILIHAN CART DAN LOGOUT -->
        <?php
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title text-center">Form Login</h4>
                            </div>
  ...
  <div id="top" >
      ...
      <div>
              <form role="search" method="POST" action="Result.php">
                  <input type="text" class="form-control" name="keyword" style="width:80%;margin:20px 10% 20px 10%;" placeholder="Cari Buku, Penulis atau Kategori">
              </form>
          </div>
      </div>
      ...
      <div class="container-fluid" id="header">
          <div class="row">
              <div class="col-md-3 col-lg-3" id="category">
                  <div style="background:#D67B22;color:#fff;font-weight:800;border:none;padding:15px;"> Toko Buku AIDA </div>
                  <ul>
                      <li> <a href="Product.php?value=entrance%20exam"> Ujian Masuk </a> </li>
                      <li> <a href="Product.php?value=Literature%20and%20Fiction"> Literatur & Fiksi </a> </li>
                      <li> <a href="Product.php?value=Academic%20and%20Professional"> Akademik & Profesional </a> </li>
                      <li> <a href="Product.php?value=Biographies%20and%20Auto%20Biographies"> Biografi & Auto Biografi </a> </li>
                      <li> <a href="Product.php?value=Children%20and%20Teens"> Anak - anak & Remaja </a> </li>
                      <li> <a href="Product.php?value=Business%20and%20Management"> Bisnis & Manajemen </a> </li>
                      <li> <a href="Product.php?value=Health%20and%20Cooking"> Kesehatan & Memasak </a> </li>
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
           <a href="description.php?ID=NEW-1&category=new">
              <div class="book-block">
                  ...
                  Like A Love Song <br>
                  $ 13  &nbsp
                  <span style="text-decoration:line-through;color:#828282;"> 75 </span>
