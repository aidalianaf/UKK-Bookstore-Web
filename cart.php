...
<?php
        ...
        if(isset($_GET['place']))
                 ...
                 ?>
                    <script type="text/javascript">
                         alert("Pilihan Buku Tercatat!! Buku akan dikirimkan COD, siapkan uang cash ya!");
                    </script>
                 <?php                  
                  }
        if(isset($_GET['remove']))
                 ...
                 ?>
                    <script type="text/javascript">
                         alert("Berhasil Menghapus Pilihan");
                    </script>
                 <?php                  
                  }     
?>
...
<head>
    ...
    <meta name="author" content="Aida Liana">
    <title>order</title>
    <!-- Bootstrap -->
...
echo '<div class="container-fluid" id="cart">
	...
	if(isset($_SESSION['user']))
                    ...
                    echo '<div class="container">
                     ...
                     echo '<div class="row">
                             <div class="col-xs-8 col-xs-offset-2  col-sm-4 col-sm-offset-2 col-md-4 col-md-offset-3 col-lg-4 col-lg-offset-3">
                                  <a href="index.php" class="btn btn-lg" style="background:#D67B22;color:white;font-weight:800;">Lanjutkan Belanja</a>
                             </div>
                             <div class="col-xs-6 col-xs-offset-3 col-sm-4 col-sm-offset-2 col-md-4 col-md-offset-1 col-lg-4 ">
                                  <a href="cart.php?place=true" class="btn btn-lg" style="background:#D67B22;color:white;font-weight:800;margin-top:5px;">Beli Buku</a>
                             </div>
                           </div>
                           ';
                } 
                        ...
                        echo ' 
                         <div class="row">
                            <div class="col-xs-9 col-xs-offset-3 col-sm-4 col-sm-offset-5 col-md-4 col-md-offset-5">
                                 <span class="text-center" style="color:#D67B22;font-weight:bold;">&nbsp &nbsp &nbsp &nbspCart Masih Kosong</span>
                             </div>
                         </div>
                         <div class="row">
                             <div class="col-xs-9 col-xs-offset-3 col-sm-2 col-sm-offset-5 col-md-2 col-md-offset-5">
                                  <a href="index.php" class="btn btn-lg" style="background:#D67B22;color:white;font-weight:800;">Mulai Belanja</a>
                             </div>
                          </div>';
                     }               
	    }
	    ...
	    { 
	          echo "Login Untuk Dapat Melanjutkan";
	    }
        echo '</div>';
	?>
